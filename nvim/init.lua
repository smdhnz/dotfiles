...
require("lazy").setup({
  ...
  },
  {
    ...
    config = function()
      ...
      -- TypeScript & Vue
      local vue_plugin_path = vim.fn.trim(vim.fn.system("npm root -g")) .. "/@vue/typescript-plugin"
      local function is_vue_project()
        local vue_config = vim.fn.glob("**/nuxt.config.ts") ~= "" or vim.fn.glob("**/vue.config.js") ~= ""
        return vue_config
      end
      lspconfig.ts_ls.setup({
        on_attach = on_attach,
        init_options = is_vue_project() and {
          plugins = {
            {
      ...
      null_ls.setup({
        sources = {
          ...
          null_ls.builtins.formatting.prettierd.with({
            filetypes = { "javascript", "typescript", "typescriptreact", "json", "css", "html", "yaml", "markdown", "vue" }
          }),
        },
